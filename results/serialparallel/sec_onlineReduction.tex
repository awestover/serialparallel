...
{\color{blue}
  We propose Algorithm~\ref{alg:thresh}, which we call THRESH, as a simple way to
  $3$-approximate ORACLE-1.
...
resulting in a $3$-competitive algorithm that uses $O(1)$ memory
...
Um, if $THRESH \le a + b$, and $OPT \ge a, OPT \ge b$, then it
sounds like $THRESH \le 2 OPT$, i.e. we're $2$-competitive. I
honestly wasn't even sure we were $3$-competitive, looks like
$2$. \textbf{Check this in the morning, I'm tired.}
