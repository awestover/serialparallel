...
$1.44$. That is, we show that for any deterministic algorithm ALG there
is some input on which ALG has awake time at least $1.44$ times
greater than OPT.
...
\todo{hypothesis: can get a better bound, of $2$, which would be tight}
